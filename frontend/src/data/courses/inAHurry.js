export const IN_A_HURRY_TOPICS = {
  ...
  'how-to-prep': {
    ...
    sections: [
      ...
      { type: 'text', heading: 'Resources', body: '**This course** — Free, structured, with detailed breakdowns\n**Designing Data-Intensive Applications (Kleppmann)** — The bible. Read chapters 1-9.\n**System Design Interview (Alex Xu)** — Interview-focused, lighter reading.\n**Mock Interviews** — Highest-ROI activity. Simulate real conditions.' },
    ],
  },
  'delivery-framework': {
