...
const COURSES = [
  ...
  },
  {
    id: 'linux',
    title: 'Linux',
    subtitle: 'Master the command line — from basics to production debugging',
    description: 'A complete Linux course for DevOps and SRE interviews. Covers commands, file systems, permissions, text processing, networking, shell scripting, and real-world debugging scenarios.',
    path: '/learn/linux',
    topics: '33',
    duration: 'Self-paced',
    difficulty: 'Beginner — Advanced',
    access: 'Free with login',
    tags: ['Commands', 'grep/sed/awk', 'Permissions', 'Networking', 'Shell Scripting', 'Troubleshooting'],
    color: 'green',
  },
  {
    id: 'aws',
