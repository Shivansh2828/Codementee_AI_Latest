...
const COURSES = [
  ...
  },
  {
    ...
    description: 'A complete DevOps interview prep course covering Linux, Git, Docker, Kubernetes, CI/CD, cloud providers, monitoring, and Infrastructure as Code.',
    path: '/learn/devops',
    topics: '54',
    duration: 'Self-paced',
    difficulty: 'Beginner — Advanced',
    access: 'Free with login',
    tags: ['Docker', 'Kubernetes', 'CI/CD', 'Terraform', 'AWS', 'Monitoring', 'Scenario Questions'],
    color: 'orange',
  },
  {
    id: 'behavioral',
